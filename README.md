...
Ikkje implementert:
	- landetpaa
	metoden trengs ikkje før slanger/stiger er implementert
	- SpillBrett 
...
Tekst for kva spiller triller 
	(kan gjøres ved ein funksjon som tar inn sum før denne endres 
	og rekonstruerer kvart trill fyrst del sum på 6
	(antall ganger trillet seks) så sum%6 for siste trill)
?? Spesialtekst viss fengsel?
	- havnet i fengsel
	- står i fengsel
